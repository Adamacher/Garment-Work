...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  db: {
    ...
    createAfterSaleOrder: (payload) => invokeBridge('db:createAfterSaleOrder', toPlainPayload(payload)),
    completeAfterSaleInbound: (payload) => invokeBridge('db:completeAfterSaleInbound', toPlainPayload(payload)),
    voidAfterSaleOrder: (payload) => invokeBridge('db:voidAfterSaleOrder', toPlainPayload(payload)),
    getAfterSaleOrders: (payload) => invokeBridge('db:getAfterSaleOrders', toPlainPayload(payload)),
    processPurchaseBatchAfterSale: (payload) => invokeBridge('db:processPurchaseBatchAfterSale', toPlainPayload(payload)),
    processFactorySupplierExchange: (payload) => invokeBridge('db:processFactorySupplierExchange', toPlainPayload(payload)),
